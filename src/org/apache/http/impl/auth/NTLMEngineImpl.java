...
implements NTLMEngine {
    ...
    extends NTLMMessage {
        ...
        Type3Message(String domain, String host, String user, String password, byte[] nonce, int type2Flags, String target, byte[] targetInformation) throws NTLMEngineException {
            ...
            try {
                if ((type2Flags & 8388608) != 0 && targetInformation != null && target != null) {
                    ...
                    userSessionKey = (type2Flags & 128) != 0 ? gen.getLanManagerSessionKey() : gen.getNTLMv2UserSessionKey();
                } else if ((type2Flags & 524288) != 0) {
                    this.ntResp = gen.getNTLM2SessionResponse();
                    this.lmResp = gen.getLM2SessionResponse();
                    userSessionKey = (type2Flags & 128) != 0 ? gen.getLanManagerSessionKey() : gen.getNTLM2SessionResponseUserSessionKey();
                } else {
                    this.ntResp = gen.getNTLMResponse();
                    this.lmResp = gen.getLMResponse();
                    userSessionKey = (type2Flags & 128) != 0 ? gen.getLanManagerSessionKey() : gen.getNTLMUserSessionKey();
                }
            }
            catch (NTLMEngineException e) {
                this.ntResp = new byte[0];
                this.lmResp = gen.getLMResponse();
                userSessionKey = (type2Flags & 128) != 0 ? gen.getLanManagerSessionKey() : gen.getLMUserSessionKey();
            }
            this.sessionKey = (type2Flags & 16) != 0 ? ((type2Flags & 1073741824) != 0 ? NTLMEngineImpl.RC4(gen.getSecondaryKey(), userSessionKey) : userSessionKey) : null;
            try {
        ...
        String getResponse() {
            ...
            this.addULong(this.type2Flags & 128 | this.type2Flags & 512 | this.type2Flags & 524288 | 33554432 | this.type2Flags & 32768 | this.type2Flags & 32 | this.type2Flags & 16 | this.type2Flags & 536870912 | this.type2Flags & Integer.MIN_VALUE | this.type2Flags & 1073741824 | this.type2Flags & 8388608 | this.type2Flags & 1 | this.type2Flags & 4);
            this.addUShort(261);
            this.addULong(2600);
            this.addUShort(3840);
    ...
    protected static class CipherGen {
        ...
        public byte[] getLM2SessionResponse() throws NTLMEngineException {
            if (this.lm2SessionResponse == null) {
                byte[] clChallenge = this.getClientChallenge();
