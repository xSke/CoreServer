...
class HttpClientConnectionOperator {
    ...
    public void connect(ManagedHttpClientConnection conn, HttpHost host, InetSocketAddress localAddress, int connectTimeout, SocketConfig socketConfig, HttpContext context) throws IOException {
        ...
        if (host.getAddress() != null) {
            InetAddress[] arrinetAddress2 = new InetAddress[1];
            arrinetAddress = arrinetAddress2;
            arrinetAddress2[0] = host.getAddress();
        } else {
            arrinetAddress = this.dnsResolver.resolve(host.getHostName());
        }
        InetAddress[] addresses = arrinetAddress;
