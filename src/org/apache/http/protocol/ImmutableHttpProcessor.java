...
implements HttpProcessor {
    ...
    public /* varargs */ ImmutableHttpProcessor(HttpRequestInterceptor ... requestInterceptors) {
        this(requestInterceptors, (HttpResponseInterceptor[])null);
    }

    public /* varargs */ ImmutableHttpProcessor(HttpResponseInterceptor ... responseInterceptors) {
