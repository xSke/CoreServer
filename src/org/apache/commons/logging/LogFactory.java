...
public abstract class LogFactory {
    ...
    protected static ClassLoader directGetContextClassLoader() throws LogConfigurationException {
        ...
        classLoader = null;
        try {
            Class class_ = class$java$lang$Thread == null ? (LogFactory.class$java$lang$Thread = LogFactory.class$("java.lang.Thread")) : class$java$lang$Thread;
            Method method = class_.getMethod("getContextClassLoader", null);
            try {
            ...
            Class class_ = class$org$apache$commons$logging$LogFactory == null ? (LogFactory.class$org$apache$commons$logging$LogFactory = LogFactory.class$("org.apache.commons.logging.LogFactory")) : class$org$apache$commons$logging$LogFactory;
            classLoader = LogFactory.getClassLoader(class_);
        }
        return classLoader;
    }
            ...
            block22 : {
                if (classLoader != null) {
                    try {
                        ...
                        Class class_ = class$org$apache$commons$logging$LogFactory == null ? (LogFactory.class$org$apache$commons$logging$LogFactory = LogFactory.class$("org.apache.commons.logging.LogFactory")) : class$org$apache$commons$logging$LogFactory;
                        if (class_.isAssignableFrom(logFactoryClass)) {
                            if (LogFactory.isDiagnosticsEnabled()) {
                                LogFactory.logDiagnostic("Loaded class " + logFactoryClass.getName() + " from classloader " + LogFactory.objectId(classLoader));
                            }
                        } else if (LogFactory.isDiagnosticsEnabled()) {
                            LogFactory.logDiagnostic("Factory class " + logFactoryClass.getName() + " loaded from classloader " + LogFactory.objectId(logFactoryClass.getClassLoader()) + " does not extend '" + (class$org$apache$commons$logging$LogFactory == null ? (LogFactory.class$org$apache$commons$logging$LogFactory = LogFactory.class$("org.apache.commons.logging.LogFactory")) : class$org$apache$commons$logging$LogFactory).getName() + "' as loaded by this classloader.");
                        ...
                        if (classLoader != thisClassLoader) break block22;
    ...
    static {
        ...
        nullClassLoaderFactory = null;
        Class class_ = class$org$apache$commons$logging$LogFactory == null ? (LogFactory.class$org$apache$commons$logging$LogFactory = LogFactory.class$("org.apache.commons.logging.LogFactory")) : class$org$apache$commons$logging$LogFactory;
        thisClassLoader = LogFactory.getClassLoader(class_);
        try {
        ...
        LogFactory.logClassLoaderEnvironment(class$org$apache$commons$logging$LogFactory == null ? (LogFactory.class$org$apache$commons$logging$LogFactory = LogFactory.class$("org.apache.commons.logging.LogFactory")) : class$org$apache$commons$logging$LogFactory);
