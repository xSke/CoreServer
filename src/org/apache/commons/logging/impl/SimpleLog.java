...
Serializable {
    ...
    private static ClassLoader getContextClassLoader() {
        ...
        classLoader = null;
        try {
            Class class_ = class$java$lang$Thread == null ? (SimpleLog.class$java$lang$Thread = SimpleLog.class$("java.lang.Thread")) : class$java$lang$Thread;
        ...
        if (classLoader == null) {
            Class class_ = class$org$apache$commons$logging$impl$SimpleLog == null ? (SimpleLog.class$org$apache$commons$logging$impl$SimpleLog = SimpleLog.class$("org.apache.commons.logging.impl.SimpleLog")) : class$org$apache$commons$logging$impl$SimpleLog;
    ...
    static {
        ...
        if (SimpleLog.showDateTime = SimpleLog.getBooleanProperty("org.apache.commons.logging.simplelog.showdatetime", showDateTime)) {
