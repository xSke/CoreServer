...
extends LogFactory {
    ...
    public LogFactoryImpl() {
        ...
        Class class_ = class$java$lang$String == null ? (LogFactoryImpl.class$java$lang$String = LogFactoryImpl.class$("java.lang.String")) : class$java$lang$String;
        arrclass[0] = class_;
        this.logConstructorSignature = arrclass;
        this.logMethod = null;
        Class[] arrclass2 = new Class[1];
        Class class_2 = class$org$apache$commons$logging$LogFactory == null ? (LogFactoryImpl.class$org$apache$commons$logging$LogFactory = LogFactoryImpl.class$("org.apache.commons.logging.LogFactory")) : class$org$apache$commons$logging$LogFactory;
        arrclass2[0] = class_2;
        this.logMethodSignature = arrclass2;
    ...
    private ClassLoader getBaseClassLoader() throws LogConfigurationException {
        Class class_ = class$org$apache$commons$logging$impl$LogFactoryImpl == null ? (LogFactoryImpl.class$org$apache$commons$logging$impl$LogFactoryImpl = LogFactoryImpl.class$("org.apache.commons.logging.impl.LogFactoryImpl")) : class$org$apache$commons$logging$impl$LogFactoryImpl;
        ClassLoader thisClassLoader = LogFactoryImpl.getClassLoader(class_);
        if (!this.useTCCL) {
    ...
    private void handleFlawedHierarchy(ClassLoader badClassLoader, Class badClass) throws LogConfigurationException {
        ...
        Class class_ = class$org$apache$commons$logging$Log == null ? (LogFactoryImpl.class$org$apache$commons$logging$Log = LogFactoryImpl.class$(LOG_PROPERTY)) : class$org$apache$commons$logging$Log;
        String logInterfaceName = class_.getName();
        ...
        if (implementsLog) {
            if (LogFactoryImpl.isDiagnosticsEnabled()) {
                try {
                    ClassLoader logInterfaceClassLoader = LogFactoryImpl.getClassLoader(class$org$apache$commons$logging$Log == null ? (LogFactoryImpl.class$org$apache$commons$logging$Log = LogFactoryImpl.class$(LOG_PROPERTY)) : class$org$apache$commons$logging$Log);
            ...
            if (!this.allowFlawedHierarchy) {
                ...
                msg.append((class$org$apache$commons$logging$Log == null ? (LogFactoryImpl.class$org$apache$commons$logging$Log = LogFactoryImpl.class$(LOG_PROPERTY)) : class$org$apache$commons$logging$Log).getName());
                msg.append("' visible.");
                if (LogFactoryImpl.isDiagnosticsEnabled()) {
