...
Serializable {
    ...
    static {
        Level _traceLevel;
        Class class_ = class$org$apache$commons$logging$impl$Log4JLogger == null ? (Log4JLogger.class$org$apache$commons$logging$impl$Log4JLogger = Log4JLogger.class$("org.apache.commons.logging.impl.Log4JLogger")) : class$org$apache$commons$logging$impl$Log4JLogger;
        FQCN = class_.getName();
        Class class_2 = class$org$apache$log4j$Priority == null ? (Log4JLogger.class$org$apache$log4j$Priority = Log4JLogger.class$("org.apache.log4j.Priority")) : class$org$apache$log4j$Priority;
        Class class_3 = class$org$apache$log4j$Level == null ? (Log4JLogger.class$org$apache$log4j$Level = Log4JLogger.class$("org.apache.log4j.Level")) : class$org$apache$log4j$Level;
        if (!class_2.isAssignableFrom(class_3)) {
            throw new InstantiationError("Log4J 1.2 not available");
        }
        try {
            _traceLevel = (Priority)(class$org$apache$log4j$Level == null ? (Log4JLogger.class$org$apache$log4j$Level = Log4JLogger.class$("org.apache.log4j.Level")) : class$org$apache$log4j$Level).getDeclaredField("TRACE").get(null);
        }
        catch (Exception ex) {
