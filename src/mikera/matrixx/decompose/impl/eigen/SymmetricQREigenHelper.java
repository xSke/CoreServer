...
public class SymmetricQREigenHelper {
    ...
    protected boolean isZero(int index) {
        ...
        return Math.abs(this.off[index]) <= bottom * EPS;
    }
    ...
    protected void eigenvalue2by2(int x1) {
        ...
        this.off[x1] = 0.0;
        this.diag[x1] = scale * this.eigenSmall.value0.x;
        this.diag[x1 + 1] = scale * this.eigenSmall.value1.x;
    }
    ...
    public double computeWilkinsonShift() {
        ...
        this.eigenSmall.symm2x2_fast(a /= scale, b /= scale, c /= scale);
        double diff0 = Math.abs(this.eigenSmall.value0.x - c);
        double diff1 = Math.abs(this.eigenSmall.value1.x - c);
        if (diff0 < diff1) {
            return scale * this.eigenSmall.value0.x;
        }
        return scale * this.eigenSmall.value1.x;
    }
