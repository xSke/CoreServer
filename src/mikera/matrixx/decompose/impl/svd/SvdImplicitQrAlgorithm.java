...
public class SvdImplicitQrAlgorithm {
    ...
    public void setUt(AMatrix ut) {
        this.Ut = ut == null ? null : ut.toMatrix();
    }
    ...
    public void setVt(AMatrix vt) {
        this.Vt = vt == null ? null : vt.toMatrix();
    }
    ...
    public double selectWilkinsonShift(double scale) {
        ...
        double diff0 = Math.abs(this.eigenSmall.value0 - a22);
        double diff1 = Math.abs(this.eigenSmall.value1 - a22);
        return diff0 < diff1 ? this.eigenSmall.value0 : this.eigenSmall.value1;
    }
    ...
    protected void eigenBB_2x2(int x1) {
        ...
        this.eigenSmall.symm2x2_fast(b11 * b11, (b11 /= scale) * b12, b12 * (b12 /= scale) + b22 * (b22 /= scale));
        this.off[x1] = 0.0;
        this.diag[x1] = scale * Math.sqrt(this.eigenSmall.value0);
        double sgn = Math.signum(this.eigenSmall.value1);
        this.diag[x1 + 1] = sgn * scale * Math.sqrt(Math.abs(this.eigenSmall.value1));
    }
    ...
    public void exceptionShift() {
        ...
        double angle = 6.283185307179586 * (this.rand.nextDouble() - 0.5) * mag;
    ...
    private Matrix createB() {
        Matrix B = Matrix.create(this.N, this.N);
    ...
    public class EigenvalueSmall {
        ...
        public void symm2x2_fast(double a11, double a12, double a22) {
            ...
            this.value0 = left + right;
            this.value1 = left - right;
        }
    }
