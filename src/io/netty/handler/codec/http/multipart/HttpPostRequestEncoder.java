    ...
    public void addBodyHttpData(InterfaceHttpData data) throws ErrorDataEncoderException {
        ...
        if (data instanceof Attribute) {
            ...
            if (this.duringMixedMode) {
                ...
                replacement.append("--").append(this.multipartDataBoundary).append("\r\n").append("Content-Disposition").append(": ").append("form-data").append("; ").append("name").append("=\"").append(fileUpload.getName()).append("\"\r\n").append("Content-Type").append(": ").append("multipart/mixed").append("; ").append("boundary").append('=').append(this.multipartMixedBoundary).append("\r\n\r\n").append("--").append(this.multipartMixedBoundary).append("\r\n").append("Content-Disposition").append(": ").append("attachment").append("; ").append("filename").append("=\"").append(fileUpload.getFilename()).append("\"\r\n");
            ...
            if (contentTransferEncoding != null && contentTransferEncoding.equals(HttpPostBodyUtil.TransferEncodingMechanism.BINARY.value())) {
                ...
                internal.addValue("; charset=" + fileUpload.getCharset().name() + "\r\n\r\n");
            } else {
                internal.addValue("\r\n\r\n");
            }
            this.multipartHttpDatas.add(internal);
