...
implements ChannelPipeline {
    ...
    private static final WeakHashMap<Class<?>, String>[] nameCaches = new WeakHashMap[java.lang.Runtime.getRuntime().availableProcessors()];
    ...
    private String generateName(ChannelHandler handler) {
        String name;
        WeakHashMap cache = nameCaches[(int)(Thread.currentThread().getId() % (long)nameCaches.length)];
    ...
    static /* synthetic */ String access$500(Class x0) {
    ...
    implements ChannelOutboundHandler {
        private static final String HEAD_NAME = DefaultChannelPipeline.access$500(HeadContext.class);
    ...
    implements ChannelInboundHandler {
        private static final String TAIL_NAME = DefaultChannelPipeline.access$500(TailContext.class);
