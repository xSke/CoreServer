...
public final class ChannelOutboundBuffer {
    ...
    private void decrementPendingOutboundBytes(long size, boolean invokeLater, boolean notifyWritability) {
        ...
        long newWriteBufferSize = TOTAL_PENDING_SIZE_UPDATER.addAndGet(this, - size);
        if (notifyWritability && (newWriteBufferSize == 0L || newWriteBufferSize <= (long)this.channel.config().getWriteBufferLowWaterMark())) {
    ...
    static {
        AtomicIntegerFieldUpdater<Object> unwritableUpdater = PlatformDependent.newAtomicIntegerFieldUpdater(ChannelOutboundBuffer.class, "unwritable");
