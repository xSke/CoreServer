...
public final class ResourceLeakDetector<T> {
    ...
    private final ResourceLeakDetector<T> head = new DefaultResourceLeak(null);
    private final ResourceLeakDetector<T> tail = new DefaultResourceLeak(null);
    ...
    private void reportLeak(Level level) {
        ...
        while ((ref = (DefaultResourceLeak)this.refQueue.poll()) != null) {
            ...
            logger.error("LEAK: {}.release() was not called before it's garbage-collected. See http://netty.io/wiki/reference-counted-objects.html for more information.{}", (Object)this.resourceType, (Object)records);
        }
    }
    ...
    implements ResourceLeak {
        ...
        private ResourceLeakDetector<T> prev;
        private ResourceLeakDetector<T> next;
        ...
        DefaultResourceLeak(Object referent) {
            ...
            if (referent != null) {
                ...
                synchronized (defaultResourceLeak) {
                    ...
                    this.next = ResourceLeakDetector.access$300((ResourceLeakDetector)ResourceLeakDetector.this).next;
                    ResourceLeakDetector.access$300((ResourceLeakDetector)ResourceLeakDetector.this).next.prev = this;
                    ResourceLeakDetector.access$300((ResourceLeakDetector)ResourceLeakDetector.this).next = this;
