...
Iterable<IntObjectMap.Entry<V>> {
    ...
    public boolean containsValue(V value) {
        V v1 = IntObjectHashMap.toInternal(value);
    ...
    public Collection<V> values() {
        AbstractCollection valueCollection = this.valueCollection;
    ...
    IntObjectMap.Entry<V> {
        ...
        public void setValue(V value) {
            IntObjectHashMap.access$200((IntObjectHashMap)IntObjectHashMap.this)[this.entryIndex] = IntObjectHashMap.toInternal(value);
        }
    }
