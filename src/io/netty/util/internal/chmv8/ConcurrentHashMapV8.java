...
Serializable {
    ...
    private static final int tableSizeFor(int c) {
        ...
        n |= n >>> 4;
        n |= n >>> 8;
        return (n |= n >>> 16) < 0 ? 1 : (n >= 1073741824 ? 1073741824 : n + 1);
    }
    ...
    public ConcurrentHashMapV8(int initialCapacity) {
        ...
        this.sizeCtl = cap = initialCapacity >= 536870912 ? 1073741824 : ConcurrentHashMapV8.tableSizeFor(initialCapacity + (initialCapacity >>> 1) + 1);
    }
    ...
    public ConcurrentHashMapV8(int initialCapacity, float loadFactor, int concurrencyLevel) {
        ...
        this.sizeCtl = cap = (size = (long)(1.0 + (double)((float)initialCapacity / loadFactor))) >= 0x40000000L ? 1073741824 : ConcurrentHashMapV8.tableSizeFor((int)size);
    }
    ...
    public V get(Object key) {
        ...
        if (tab != null && (n = tab.length) > 0 && (e = ConcurrentHashMapV8.tabAt(tab, n - 1 & h)) != null) {
            Object ek;
            int eh = e.hash;
            if (eh == h) {
                ek = e.key;
    ...
    public KeySetView<K, V> keySet() {
        ...
        KeySetView<K, Object> keySetView = ks != null ? ks : (this.keySet = new KeySetView(this, null));
        return keySetView;
    }
    ...
    public Collection<V> values() {
        ...
        ValuesView<K, V> valuesView = vs != null ? vs : (this.values = new ValuesView(this));
        return valuesView;
    }
    ...
    public Set<Map.Entry<K, V>> entrySet() {
        ...
        EntrySetView<K, V> entrySetView = es != null ? es : (this.entrySet = new EntrySetView(this));
        return entrySetView;
    }
                    ...
                    block37 : {
                        if (ConcurrentHashMapV8.tabAt(tab, i) == f) {
                            ...
                            if (f instanceof TreeBin) {
                                ...
                                TreeBin t = (TreeBin)f;
                                TreeNode r2 = t.root;
                                TreeNode p = r2 != null ? r2.findTreeNode(h, key, null) : null;
                                Object pv = p == null ? null : p.val;
                                val = remappingFunction.apply(key, (Object)pv);
                                if (val != null) {
                                    if (p != null) {
                                        p.val = val;
                                    } else {
                    ...
                    block27 : {
                        if (ConcurrentHashMapV8.tabAt(tab, i) == f) {
                            ...
                            if (f instanceof TreeBin) {
                                ...
                                val = p == null ? value : remappingFunction.apply((Object)p.val, value);
                                if (val != null) {
                                    if (p != null) {
                                        p.val = val;
                                    } else {
    ...
    public static <K> KeySetView<K, Boolean> newKeySet() {
        return new KeySetView<K, Boolean>(new ConcurrentHashMapV8<K, V>(), Boolean.TRUE);
    }

    public static <K> KeySetView<K, Boolean> newKeySet(int initialCapacity) {
        return new KeySetView<K, Boolean>(new ConcurrentHashMapV8<K, V>(initialCapacity), Boolean.TRUE);
    }
    ...
    private final Node<K, V>[] initTable() {
        ...
        while ((tab = this.table) == null || tab.length == 0) {
            ...
            try {
                tab = this.table;
                if (tab != null && tab.length != 0) break;
                int n = sc > 0 ? sc : 16;
                Node[] nt = new Node[n];
                this.table = tab = nt;
                sc = n - (n >>> 2);
    ...
    private final void addCount(long x, int check) {
        ...
        if (as != null || !U.compareAndSwapLong(this, BASECOUNT, b = this.baseCount, s = b + x)) {
            long v;
            CounterCell a;
            int m;
        ...
        if (check >= 0) {
            int sc;
            Node<K, V>[] tab;
            while (s >= (long)(sc = this.sizeCtl) && (tab = this.table) != null && tab.length < 1073741824) {
                if (sc < 0) {
                    Node<K, V>[] nt;
                    if (sc == -1 || this.transferIndex <= this.transferOrigin || (nt = this.nextTable) == null) break;
    ...
    private final void tryPresize(int size) {
        int sc;
        int c;
        int n = c = size >= 536870912 ? 1073741824 : ConcurrentHashMapV8.tableSizeFor(size + (size >>> 1) + 1);
        ...
        do {
            block33 : {
                ...
                if (i < 0 || i >= n || i + n >= nextn) {
                    ...
                    do {
                        n2 = sc = this.sizeCtl;
                    } while (!U.compareAndSwapInt(this, SIZECTL, n2, ++sc));
                    if (sc != -1) {
                        return;
                    }
                    advance = true;
                ...
                synchronized (sc) {
                    ...
                    block36 : {
                        ...
                        block35 : {
                            block34 : {
                                if (ConcurrentHashMapV8.tabAt(tab, i) != f) break block33;
                                if (fh < 0) break block34;
                                int runBit = fh & n;
                                lastRun = f;
                                p = f.next;
                                while (p != null) {
                            ...
                            if (!(f instanceof TreeBin)) break block33;
                            t = f;
                            lo = null;
                            loTail = null;
                            hi = null;
                    ...
                    TreeBin treeBin = lc <= 6 ? ConcurrentHashMapV8.untreeify(lo) : (ln = hc != 0 ? new TreeBin(lo) : t);
    ...
    implements ConcurrentHashMapSpliterator<Map.Entry<K, V>> {
        ...
        public ConcurrentHashMapSpliterator<Map.Entry<K, V>> trySplit() {
            ...
            int h = i + f >>> 1;
            return h <= i ? null : new EntrySpliterator<K, V>(this.tab, this.baseSize, h, f, this.est >>> 1, this.map);
        }
    ...
    implements ConcurrentHashMapSpliterator<V> {
        ...
        public ConcurrentHashMapSpliterator<V> trySplit() {
            ...
            int f = this.baseLimit;
            int h = i + f >>> 1;
            return h <= i ? null : new ValueSpliterator<K, V>(this.tab, this.baseSize, h, f, this.est >>> 1);
        }
    ...
    implements ConcurrentHashMapSpliterator<K> {
        ...
        public ConcurrentHashMapSpliterator<K> trySplit() {
            ...
            int f = this.baseLimit;
            int h = i + f >>> 1;
            return h <= i ? null : new KeySpliterator<K, V>(this.tab, this.baseSize, h, f, this.est >>> 1);
        }
