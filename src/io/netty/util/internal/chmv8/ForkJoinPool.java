...
extends AbstractExecutorService {
    ...
    private int acquirePlock() {
        ...
        do {
            int ps;
            int nps;
            if (((ps = this.plock) & 2) == 0 && U.compareAndSwapInt(this, PLOCK, ps, nps = ps + 2)) {
                return nps;
            }
            if (spins >= 0) {
    ...
    private void tryAddWorker() {
        ...
        int u;
        int e;
        while ((u = (int)((c = this.ctl) >>> 32)) < 0 && (u & 32768) != 0 && (e = (int)c) >= 0) {
            long nc = (long)(u + 1 & 65535 | u + 65536 & -65536) << 32 | (long)e;
    ...
    final WorkQueue registerWorker(ForkJoinWorkerThread wt) {
        ...
        block15 : {
            block14 : {
                ...
                do {
                    n = s = this.indexSeed;
                } while (!U.compareAndSwapInt(this, INDEXSEED, n, s += 1640531527) || s == 0);
                w = new WorkQueue(this, wt, this.mode, s);
                ps = this.plock;
                if ((ps & 2) != 0) break block14;
                int n2 = ps;
                if (U.compareAndSwapInt(this, PLOCK, n2, ps += 2)) break block15;
            }
    ...
    final void deregisterWorker(ForkJoinWorkerThread wt, Throwable ex) {
        ...
        block16 : {
            ...
            block18 : {
                block17 : {
                    long sc;
                    w = null;
                    if (wt == null || (w = wt.workQueue) == null) break block16;
                    w.qlock = -1;
                    while (!U.compareAndSwapLong(this, STEALCOUNT, sc = this.stealCount, sc + (long)w.nsteals)) {
                    }
                    ps = this.plock;
                    if ((ps & 2) != 0) break block17;
                    int n = ps;
                    if (U.compareAndSwapInt(this, PLOCK, n, ps += 2)) break block18;
                }
                ps = this.acquirePlock();
            }
            int nps = ps & Integer.MIN_VALUE | ps + 2 & Integer.MAX_VALUE;
        ...
        while (!U.compareAndSwapLong(this, CTL, c = this.ctl, c - 0x1000000000000L & -281474976710656L | c - 0x100000000L & 0xFFFF00000000L | c & 0xFFFFFFFFL)) {
        }
        if (!this.tryTerminate(false, false) && w != null && w.array != null) {
            ...
            while ((u = (int)((c = this.ctl) >>> 32)) < 0 && (e = (int)c) >= 0) {
                if (e > 0) {
                    ...
                    WorkQueue v;
                    WorkQueue[] ws = this.workQueues;
                    if (ws == null || (i = e & 65535) >= ws.length || (v = ws[i]) == null) break;
    ...
    final void externalPush(ForkJoinTask<?> task) {
        ...
        if (z != null && ps > 0 && ws != null && (m = ws.length - 1) >= 0 && (q = ws[m & (r = z.seed) & 126]) != null && r != 0 && U.compareAndSwapInt(q, QLOCK, 0, 1)) {
            ...
            if (a != null && (am = a.length - 1) > (n = (s = q.top) - q.base)) {
                    ...
                    block30 : {
                        ...
                        block26 : {
                            ...
                            block28 : {
                                block27 : {
                                    if (z == null) {
                                        int n = r = this.indexSeed;
                                        if (U.compareAndSwapInt(this, INDEXSEED, n, r += 1640531527) && r != 0) {
                                            z = new Submitter(r);
                                            submitters.set(z);
                                        }
                                    } else if (r == 0) {
                                    ...
                                    if (ps != 0 && (ws = this.workQueues) != null && (m = ws.length - 1) >= 0) break block26;
                                    short p = this.parallelism;
                                    int n = p > 1 ? p - 1 : 1;
                                    n |= n >>> 1;
                                    n |= n >>> 2;
                                    n |= n >>> 4;
                                    ...
                                    n = n + 1 << 1;
                                    ws = this.workQueues;
                                    nws = ws == null || ws.length == 0 ? new WorkQueue[n] : null;
                                    ps = this.plock;
                                    if ((ps & 2) != 0) break block27;
                                    int n2 = ps;
                                    if (U.compareAndSwapInt(this, PLOCK, n2, ps += 2)) break block28;
                                }
                                ps = this.acquirePlock();
                            }
                            ...
                            if (U.compareAndSwapInt(this, PLOCK, ps, nps2 = ps & Integer.MIN_VALUE | ps + 2 & Integer.MAX_VALUE)) continue;
                        ...
                        ps = this.plock;
                        if ((ps & 2) != 0) break block29;
                        q = new WorkQueue(this, null, -1, r);
                        q.poolIndex = (short)k;
                        ps = this.plock;
                        if ((ps & 2) != 0) break block30;
                        int n = ps;
                        if (U.compareAndSwapInt(this, PLOCK, n, ps += 2)) break block31;
                    }
                    ps = this.acquirePlock();
                }
    ...
    final void incrementActiveCount() {
        long c;
        while (!U.compareAndSwapLong(this, CTL, c = this.ctl, c & 0xFFFFFFFFFFFFL | (c & -281474976710656L) + 0x1000000000000L)) {
        }
    }
    ...
    final void signalWork(WorkQueue[] ws, WorkQueue q) {
        ...
        while ((u = (int)((c = this.ctl) >>> 32)) < 0) {
            ...
            if (ws == null || ws.length <= (i = e & 65535) || (w = ws[i]) == null) break;
    ...
    private final int scan(WorkQueue w, int r) {
        block6 : {
            ...
            long c = this.ctl;
            WorkQueue[] ws = this.workQueues;
            if (ws == null || (m = ws.length - 1) < 0 || w == null) break block6;
            int j = m + m + 1;
            int ec = w.eventCount;
            do {
                ForkJoinTask<?>[] a;
                WorkQueue q;
                int b;
                if ((q = ws[r - j & m]) == null || (b = q.base) - q.top >= 0 || (a = q.array) == null) continue;
            ...
            if (this.ctl == c) {
                long nc = (long)ec | c - 0x1000000000000L & -4294967296L;
                w.nextWait = e;
            ...
            if (e < 0 || d <= 0 && this.tryTerminate(false, false)) {
                ...
                if (ns != 0) {
                    ...
                    if (w.eventCount == ec && this.ctl == c) {
                        ...
                        w.parker = null;
                        U.putObject((Object)wt, PARKBLOCKER, (Object)null);
            ...
            do {
                block9 : {
                    ...
                    do lbl-1000: // 3 sources:
                    {
                        ...
                        b = v.base;
                        if (b - v.top >= 0 || (a = v.array) == null) break block9;
    ...
    private int helpComplete(WorkQueue joiner, CountedCompleter<?> task) {
        ...
        int s = 0;
        WorkQueue[] ws = this.workQueues;
        if (ws != null && (m = ws.length - 1) >= 0 && joiner != null && task != null) {
        ...
        if (ws != null && (m = ws.length - 1) >= 0 && e >= 0 && this.ctl == c) {
            ...
            if (e != 0 && w != null) {
                ...
                if (tc >= 0 && (int)(c >> 48) + pc > 1) {
                    long nc2 = c - 0x1000000000000L & -281474976710656L | c & 0xFFFFFFFFFFFFL;
                    if (U.compareAndSwapLong(this, CTL, c, nc2)) {
                        return true;
                    }
                } else if (tc + pc < 32767 && U.compareAndSwapLong(this, CTL, c, nc = c + 0x100000000L & 0xFFFF00000000L | c & -281470681743361L)) {
                    Throwable ex = null;
                    ForkJoinWorkerThread wt = null;
                    try {
                        ForkJoinWorkerThreadFactory fac = this.factory;
    ...
    private WorkQueue findNonEmptyStealQueue() {
        ...
        do {
            ...
            ps = this.plock;
            WorkQueue[] ws = this.workQueues;
            if (ws == null || (m = ws.length - 1) < 0) continue;
    ...
    final void helpQuiescePool(WorkQueue w) {
        ...
        do {
            ...
            if (active) {
                c = this.ctl;
                long nc = c & 0xFFFFFFFFFFFFL | (c & -281474976710656L) - 0x1000000000000L;
            ...
            c = this.ctl;
            if ((int)(c >> 48) + this.parallelism <= 0 && U.compareAndSwapLong(this, CTL, c, c & 0xFFFFFFFFFFFFL | (c & -281474976710656L) + 0x1000000000000L)) return;
        } while (true);
    }
        ...
        block22 : {
            block24 : {
                block23 : {
                    ...
                    if ((ps & 2) != 0) break block23;
                    v0 = ps;
                    if (ForkJoinPool.U.compareAndSwapInt(this, ForkJoinPool.PLOCK, v0, ps += 2)) break block24;
                }
                ps = this.acquirePlock();
            }
            if (!ForkJoinPool.U.compareAndSwapInt(this, ForkJoinPool.PLOCK, ps, nps = ps + 2 & Integer.MAX_VALUE | Integer.MIN_VALUE)) {
                this.releasePlock(nps);
            }
        }
        block4 : do lbl-1000: // 3 sources:
        {
            ...
            do {
                ...
                if (ws != null) {
                    ...
                    while ((e = (int)(cc = this.ctl) & Integer.MAX_VALUE) != 0 && (i = e & 65535) < n && i >= 0 && (w = ws[i]) != null) {
                        nc = (long)(w.nextWait & Integer.MAX_VALUE) | cc + 0x1000000000000L & -281474976710656L | cc & 281472829227008L;
                        if (w.eventCount != (e | Integer.MIN_VALUE) || !ForkJoinPool.U.compareAndSwapLong(this, ForkJoinPool.CTL, cc, nc)) continue;
    ...
    static WorkQueue commonSubmitterQueue() {
        ...
        ForkJoinPool p;
        Submitter z = submitters.get();
        return z != null && (p = common) != null && (ws = p.workQueues) != null && (m = ws.length - 1) >= 0 ? ws[m & z.seed & 126] : null;
    }
    ...
    final boolean tryExternalUnpush(ForkJoinTask<?> task) {
        ...
        if (z != null && ws != null && (m = ws.length - 1) >= 0 && (joiner = ws[z.seed & m & 126]) != null && joiner.base != (s = joiner.top) && (a = joiner.array) != null && U.getObject(a, j = (long)(((a.length - 1 & s - 1) << ASHIFT) + ABASE)) == task && U.compareAndSwapInt(joiner, QLOCK, 0, 1)) {
    ...
    private ForkJoinPool(int parallelism, ForkJoinWorkerThreadFactory factory, Thread.UncaughtExceptionHandler handler, int mode, String workerNamePrefix) {
        ...
        long np = - parallelism;
        this.ctl = np << 48 & -281474976710656L | np << 32 & 0xFFFF00000000L;
    }
    ...
    public String toString() {
        ...
        return Object.super.toString() + "[" + level + ", parallelism = " + pc + ", size = " + tc + ", active = " + ac + ", running = " + rc + ", steals = " + st + ", tasks = " + qt + ", submissions = " + qs + "]";
    }
    ...
    public boolean awaitQuiescence(long timeout, TimeUnit unit) {
        ...
        int r = 0;
        boolean found = true;
        block0 : while (!this.isQuiescent() && (ws = this.workQueues) != null && (m = ws.length - 1) >= 0) {
            if (!found) {
    ...
    static final class WorkQueue {
        ...
        final ForkJoinTask<?> pollAt(int b) {
            ...
            ForkJoinTask t;
            ForkJoinTask<?>[] a = this.array;
            if (a != null && (t = (ForkJoinTask)U.getObjectVolatile(a, j = ((a.length - 1 & b) << ASHIFT) + ABASE)) != null && this.base == b && U.compareAndSwapObject(a, j, t, null)) {
        ...
        final boolean tryUnpush(ForkJoinTask<?> t) {
            int s;
            ForkJoinTask<?>[] a = this.array;
            if (a != null && (s = this.top) != this.base && U.compareAndSwapObject(a, ((a.length - 1 & --s) << ASHIFT) + ABASE, t, null)) {
                this.top = s;
                return true;
            }
            return false;
        ...
        final boolean pollAndExecCC(CountedCompleter<?> root) {
            block4 : {
                ForkJoinTask<?>[] a;
                int b = this.base;
                if (b - this.top >= 0 || (a = this.array) == null) break block4;
        ...
        final boolean externalPopAndExecCC(CountedCompleter<?> root) {
            block4 : {
                ...
                ForkJoinTask<?>[] a;
                int s = this.top;
                if (this.base - s >= 0 || (a = this.array) == null || !((o = U.getObject(a, j = (long)(((a.length - 1 & s - 1) << ASHIFT) + ABASE))) instanceof CountedCompleter)) break block4;
                CountedCompleter r = t = (CountedCompleter)o;
                do {
                    if (r != root) continue;
        ...
        final boolean internalPopAndExecCC(CountedCompleter<?> root) {
            block2 : {
                ...
                ForkJoinTask<?>[] a;
                int s = this.top;
                if (this.base - s >= 0 || (a = this.array) == null || !((o = U.getObject(a, j = (long)(((a.length - 1 & s - 1) << ASHIFT) + ABASE))) instanceof CountedCompleter)) break block2;
                CountedCompleter r = t = (CountedCompleter)o;
                do {
                    if (r != root) continue;
