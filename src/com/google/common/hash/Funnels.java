...
public final class Funnels {
    ...
    extends OutputStream {
        ...
        public String toString() {
            String string = String.valueOf(String.valueOf(this.sink));
            return new StringBuilder(24 + string.length()).append("Funnels.asOutputStream(").append(string).append(")").toString();
        }
    }
    ...
    Serializable {
        ...
        public String toString() {
            String string = String.valueOf(String.valueOf(this.elementFunnel));
            return new StringBuilder(26 + string.length()).append("Funnels.sequentialFunnel(").append(string).append(")").toString();
        }
    ...
    Serializable {
        ...
        public String toString() {
            String string = String.valueOf(String.valueOf(this.charset.name()));
            return new StringBuilder(22 + string.length()).append("Funnels.stringFunnel(").append(string).append(")").toString();
        }
