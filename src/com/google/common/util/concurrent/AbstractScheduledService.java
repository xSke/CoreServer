        ...
        protected final void doStart() {
            this.executorService = MoreExecutors.renamingDecorator(AbstractScheduledService.this.executor(), new Supplier<String>(){
                ...
                public String get() {
                    ...
                    String string2 = String.valueOf(String.valueOf((Object)1.this.state()));
            ...
            this.executorService.execute(new Runnable(){
                ...
                public void run() {
                    ...
                    try {
                        ...
                        1.this.runningTask = AbstractScheduledService.this.scheduler().schedule(AbstractScheduledService.this.delegate, 1.this.executorService, 1.this.task);
            ...
            this.executorService.execute(new Runnable(){
                ...
                public void run() {
                    try {
                        1.this.lock.lock();
                        try {
                            if (1.this.state() != Service.State.STOPPING) {
                                return;
                            }
                            AbstractScheduledService.this.shutDown();
                        }
