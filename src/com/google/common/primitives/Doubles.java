...
public final class Doubles {
    ...
    private static Pattern fpPattern() {
        ...
        String string = String.valueOf(String.valueOf(hex));
        String completeHex = new StringBuilder(25 + string.length()).append("0[xX]").append(string).append("[pP][+-]?\\d++[fFdD]?").toString();
        String string2 = String.valueOf(String.valueOf(completeDec));
        String string3 = String.valueOf(String.valueOf(completeHex));
        String fpPattern = new StringBuilder(23 + string2.length() + string3.length()).append("[+-]?(?:NaN|Infinity|").append(string2).append("|").append(string3).append(")").toString();
