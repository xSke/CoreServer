...
public final class MediaType {
    ...
    public static MediaType parse(String input) {
        ...
        try {
            ...
            String subtype = String.valueOf(String.valueOf(input));
            throw new IllegalArgumentException(new StringBuilder(18 + subtype.length()).append("Could not parse '").append(subtype).append("'").toString(), e);
        }
    }
