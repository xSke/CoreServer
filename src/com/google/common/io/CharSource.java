...
public abstract class CharSource {
    ...
    extends CharSource {
        ...
        public String toString() {
            ...
            return new StringBuilder(19 + string.length()).append("CharSource.concat(").append(string).append(")").toString();
        }
    }
    ...
    extends CharSource {
        ...
        public String toString() {
            String string = String.valueOf(String.valueOf(Ascii.truncate(this.seq, 30, "...")));
            return new StringBuilder(17 + string.length()).append("CharSource.wrap(").append(string).append(")").toString();
        }
