...
public abstract class BaseEncoding {
    ...
    extends BaseEncoding {
        ...
        public String toString() {
            String string = String.valueOf(String.valueOf(this.delegate.toString()));
            String string2 = String.valueOf(String.valueOf(this.separator));
            int n = this.afterEveryChars;
            return new StringBuilder(31 + string.length() + string2.length()).append(string).append(".withSeparator(\"").append(string2).append("\", ").append(n).append(")").toString();
        }
    }
        ...
        GwtWorkarounds.ByteOutput encodingStream(final GwtWorkarounds.CharOutput out) {
            ...
            return new GwtWorkarounds.ByteOutput(){
                ...
                public void write(byte b) throws IOException {
                    ...
                    while (this.bitBufferLength >= StandardBaseEncoding.access$000((StandardBaseEncoding)StandardBaseEncoding.this).bitsPerChar) {
                        int charIndex = this.bitBuffer >> this.bitBufferLength - StandardBaseEncoding.access$000((StandardBaseEncoding)StandardBaseEncoding.this).bitsPerChar & StandardBaseEncoding.access$000((StandardBaseEncoding)StandardBaseEncoding.this).mask;
                        out.write(StandardBaseEncoding.this.alphabet.encode(charIndex));
                        ++this.writtenChars;
                        this.bitBufferLength -= StandardBaseEncoding.access$000((StandardBaseEncoding)StandardBaseEncoding.this).bitsPerChar;
                    }
                }
                ...
                public void close() throws IOException {
                    if (this.bitBufferLength > 0) {
                        int charIndex = this.bitBuffer << StandardBaseEncoding.access$000((StandardBaseEncoding)StandardBaseEncoding.this).bitsPerChar - this.bitBufferLength & StandardBaseEncoding.access$000((StandardBaseEncoding)StandardBaseEncoding.this).mask;
                        out.write(StandardBaseEncoding.this.alphabet.encode(charIndex));
                        ++this.writtenChars;
                        if (StandardBaseEncoding.this.paddingChar != null) {
                            while (this.writtenChars % StandardBaseEncoding.access$000((StandardBaseEncoding)StandardBaseEncoding.this).charsPerChunk != 0) {
                ...
                public int read() throws IOException {
                    do {
                        ...
                        if (this.hitPadding) {
                            char c = ch;
                            int n = this.readChars;
                            throw new DecodingException(new StringBuilder(61).append("Expected padding character but found '").append(c).append("' at index ").append(n).toString());
                        }
                        this.bitBuffer <<= StandardBaseEncoding.access$000((StandardBaseEncoding)StandardBaseEncoding.this).bitsPerChar;
