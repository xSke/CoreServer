    ...
    public synchronized void reset() throws IOException {
        try {
            ...
            if (this.file != null) {
                ...
                this.file = null;
                if (!deleteMe.delete()) {
                    String string = String.valueOf(String.valueOf(deleteMe));
                    throw new IOException(new StringBuilder(18 + string.length()).append("Could not delete: ").append(string).toString());
                }
            }
        }
    }
