...
public final class CacheBuilderSpec {
    ...
    private static final ImmutableMap<String, ValueParser> VALUE_PARSERS = ImmutableMap.builder().put("initialCapacity", new InitialCapacityParser()).put("maximumSize", (InitialCapacityParser)((Object)new MaximumSizeParser())).put("maximumWeight", (MaximumSizeParser)((Object)new MaximumWeightParser())).put("concurrencyLevel", (MaximumWeightParser)((Object)new ConcurrencyLevelParser())).put("weakKeys", (ConcurrencyLevelParser)((Object)new KeyStrengthParser(LocalCache.Strength.WEAK))).put("softValues", (KeyStrengthParser)((Object)new ValueStrengthParser(LocalCache.Strength.SOFT))).put("weakValues", new ValueStrengthParser(LocalCache.Strength.WEAK)).put("recordStats", (ValueStrengthParser)((Object)new RecordStatsParser())).put("expireAfterAccess", (RecordStatsParser)((Object)new AccessDurationParser())).put("expireAfterWrite", (AccessDurationParser)((Object)new WriteDurationParser())).put("refreshAfterWrite", (WriteDurationParser)((Object)new RefreshDurationParser())).put("refreshInterval", new RefreshDurationParser()).build();
    @VisibleForTesting
