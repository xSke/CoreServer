...
implements Serializable {
    ...
    implements RandomAccess {
        RandomAccessWrappedList(List<V> key, @Nullable AbstractMapBasedMultimap<K, V> delegate) {
    ...
    extends AbstractMapBasedMultimap<K, V>
    implements List<V> {
        WrappedList(List<V> key, @Nullable AbstractMapBasedMultimap<K, V> delegate) {
            super((AbstractMapBasedMultimap)this$0, key, delegate, ancestor);
        }
        ...
        public boolean addAll(int index, Collection<? extends V> c) {
            ...
            if (changed) {
                ...
                this$0.totalSize += newSize - oldSize;
                if (oldSize == 0) {
                    this.addToMap();
                }
            }
    ...
    implements NavigableSet<V> {
        WrappedNavigableSet(NavigableSet<V> key, @Nullable AbstractMapBasedMultimap<K, V> delegate) {
            super((AbstractMapBasedMultimap)this$0, key, delegate, ancestor);
        }
    ...
    implements SortedSet<V> {
        WrappedSortedSet(SortedSet<V> key, @Nullable AbstractMapBasedMultimap<K, V> delegate) {
            super((AbstractMapBasedMultimap)this$0, key, delegate, ancestor);
        }
    ...
    extends AbstractCollection<V> {
        ...
        WrappedCollection(Collection<V> key, @Nullable AbstractMapBasedMultimap<K, V> delegate) {
            this.key = key;
        ...
        implements Iterator<V> {
            ...
            WrappedIterator() {
                ...
                this.delegateIterator = this$0.iteratorOrListIterator(WrappedCollection.this.delegate);
            }
