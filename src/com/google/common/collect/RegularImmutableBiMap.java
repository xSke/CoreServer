...
extends ImmutableBiMap<K, V> {
    ...
    /* varargs */ RegularImmutableBiMap(ImmutableMapEntry.TerminalEntry<?, ?> ... entriesToAdd) {
    ...
    ImmutableSet<Map.Entry<K, V>> createEntrySet() {
        return new ImmutableMapEntrySet<K, V>(){
            ...
            ImmutableList<Map.Entry<K, V>> createAsList() {
                return new RegularImmutableAsList<Map.Entry<K, V>>(this, RegularImmutableBiMap.this.entries);
            }
    ...
    extends ImmutableBiMap<V, K> {
        ...
        public K get(@Nullable Object value) {
            ...
            for (ImmutableMapEntry entry = RegularImmutableBiMap.access$400((RegularImmutableBiMap)RegularImmutableBiMap.this)[bucket]; entry != null; entry = entry.getNextInValueBucket()) {
