...
Serializable {
    ...
    private V put(@Nullable K key, @Nullable V value, boolean force) {
        ...
        if (oldEntryForValue != null) {
            if (force) {
                ...
                throw new IllegalArgumentException(new StringBuilder(23 + string.length()).append("value already present: ").append(string).toString());
            }
        }
    ...
    Serializable {
        ...
        public K get(@Nullable Object value) {
            ...
            return (K)(entry == null ? null : entry.key);
        }
