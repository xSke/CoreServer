...
extends AbstractTable<R, C, V> {
    private static final ImmutableTable<Object, Object, Object> EMPTY = new SparseImmutableTable<Object, Object, Object>(ImmutableList.<Table.Cell<R, C, V>>of(), ImmutableSet.<E>of(), ImmutableSet.<E>of());
    ...
    public ImmutableMap<R, V> column(C columnKey) {
        ...
        return MoreObjects.firstNonNull((ImmutableMap)this.columnMap().get(columnKey), ImmutableMap.<K, V>of());
    }
    ...
    public ImmutableMap<C, V> row(R rowKey) {
        ...
        return MoreObjects.firstNonNull((ImmutableMap)this.rowMap().get(rowKey), ImmutableMap.<K, V>of());
    }
