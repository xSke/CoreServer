...
public final class Multisets {
    ...
    public static boolean removeOccurrences(Multiset<?> multisetToModify, Iterable<?> occurrencesToRemove) {
        if (occurrencesToRemove instanceof Multiset) {
            return Multisets.removeOccurrencesImpl(multisetToModify, (Multiset)occurrencesToRemove);
        }
    ...
    implements Multiset.Entry<E> {
        ...
        public String toString() {
            ...
            if (n == 1) {
                ...
                String string2 = String.valueOf(String.valueOf(text));
                int n2 = n;
                string = new StringBuilder(14 + string2.length()).append(string2).append(" x ").append(n2).toString();
            }
            return string;
        }
    }
