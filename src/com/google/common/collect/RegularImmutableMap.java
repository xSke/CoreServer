...
extends ImmutableMap<K, V> {
    ...
    /* varargs */ RegularImmutableMap(ImmutableMapEntry.TerminalEntry<?, ?> ... theEntries) {
    ...
    RegularImmutableMap(int size, ImmutableMapEntry.TerminalEntry<?, ?>[] theEntries) {
        ...
        for (int entryIndex = 0; entryIndex < size; ++entryIndex) {
            ...
            ImmutableMapEntry newEntry = existing == null ? entry : new NonTerminalMapEntry(entry, existing);
    ...
    extends ImmutableMapEntrySet<K, V> {
        ...
        ImmutableList<Map.Entry<K, V>> createAsList() {
            return new RegularImmutableAsList<Map.Entry<K, V>>(this, RegularImmutableMap.this.entries);
        }
    }
