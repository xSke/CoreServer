...
public final class Maps {
    ...
    public static <K, V> Map<K, V> filterKeys(Map<K, V> unfiltered, Predicate<? super K> keyPredicate) {
        ...
        Predicate entryPredicate = Maps.keyPredicateOnEntries(keyPredicate);
    ...
    Serializable {
        ...
        public NavigableMap<K, V> descendingMap() {
            ...
            UnmodifiableNavigableMap<K, V> unmodifiableNavigableMap = result == null ? (this.descendingMap = new UnmodifiableNavigableMap<K, V>(this.delegate.descendingMap(), this)) : result;
    ...
    implements Serializable {
        ...
        public String toString() {
            String string = String.valueOf(String.valueOf(this.bimap));
            return new StringBuilder(18 + string.length()).append("Maps.asConverter(").append(string).append(")").toString();
        }
    }
    ...
    implements MapDifference.ValueDifference<V> {
        ...
        public String toString() {
            String string = String.valueOf(String.valueOf(this.left));
            String string2 = String.valueOf(String.valueOf(this.right));
