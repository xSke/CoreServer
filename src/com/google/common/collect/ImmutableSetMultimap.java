...
implements SetMultimap<K, V> {
    ...
    private void readObject(ObjectInputStream stream) throws IOException, ClassNotFoundException {
        ...
        if (keyCount < 0) {
            int n = keyCount;
            throw new InvalidObjectException(new StringBuilder(29).append("Invalid key count ").append(n).toString());
        }
        ...
        for (int i = 0; i < keyCount; ++i) {
            ...
            if (valueCount <= 0) {
                int n = valueCount;
                throw new InvalidObjectException(new StringBuilder(31).append("Invalid value count ").append(n).toString());
            }
            ...
            if (valueSet.size() != array.length) {
                ...
                throw new InvalidObjectException(new StringBuilder(40 + string.length()).append("Duplicate key-value pairs exist for key ").append(string).toString());
            }
        ...
        ImmutableMultimap.FieldSettersHolder.MAP_FIELD_SETTER.set((ImmutableSetMultimap)this, tmpMap);
