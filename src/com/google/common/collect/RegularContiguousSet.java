...
extends ContiguousSet<C> {
    ...
    public ContiguousSet<C> intersection(ContiguousSet<C> other) {
        ...
        return lowerEndpoint.compareTo(upperEndpoint = (Comparable)Ordering.natural().min((Object)this.last(), other.last())) < 0 ? ContiguousSet.create(Range.closed(lowerEndpoint, upperEndpoint), this.domain) : new EmptyContiguousSet(this.domain);
    }
