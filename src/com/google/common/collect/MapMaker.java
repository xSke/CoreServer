...
extends GenericMapMaker<Object, Object> {
    ...
    implements Serializable {
        ...
        public V get(Object key) {
            ...
            if (value == null) {
                String e = String.valueOf(String.valueOf(this.computingFunction));
                String cause = String.valueOf(String.valueOf(key));
                throw new NullPointerException(new StringBuilder(24 + e.length() + cause.length()).append(e).append(" returned null for key ").append(cause).append(".").toString());
            }
            return value;
        }
    }
