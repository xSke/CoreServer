    ...
    extends MapMakerInternalMap.Segment<K, V> {
        ...
        V getOrCompute(K key, int hash, Function<? super K, ? extends V> computingFunction) throws ExecutionException {
            try {
                ...
                do {
                    ...
                    if (e == null || !e.getValueReference().isComputingReference()) {
                        ...
                        try {
                            ...
                            for (e = first = (MapMakerInternalMap.ReferenceEntry<Object, Object>)table.get((int)index); e != null; e = e.getNext()) {
                        ...
                        if (createNewEntry) {
                            V newCount = this.compute(key, hash, e, computingValueReference);
                            return newCount;
                        }
                    }
                ...
                this.recordRead(e);
                computingValueReference = (ComputingValueReference<? super K, ? extends V>)value;
