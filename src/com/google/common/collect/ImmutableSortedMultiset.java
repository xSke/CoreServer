...
implements SortedMultiset<E> {
    ...
    private static <E> ImmutableSortedMultiset<E> copyOfSortedEntries(Comparator<? super E> comparator, Collection<Multiset.Entry<E>> entries) {
        ...
        return new RegularImmutableSortedMultiset<E>(new RegularImmutableSortedSet<E>((ImmutableList<? super E>)elementsBuilder.build(), comparator), counts, cumulativeCounts, 0, entries.size());
    }
    ...
    public ImmutableSortedMultiset<E> descendingMultiset() {
        ...
        if (result == null) {
            this.descendingMultiset = new DescendingImmutableSortedMultiset<E>(this);
