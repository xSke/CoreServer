...
public final class Iterators {
    ...
    public static <T> T getOnlyElement(Iterator<T> iterator) {
        ...
        String string = String.valueOf(String.valueOf(first));
        sb.append(new StringBuilder(31 + string.length()).append("expected one element but was: <").append(string).toString());
        for (int i = 0; i < 4 && iterator.hasNext(); ++i) {
            String string2 = String.valueOf(String.valueOf(iterator.next()));
            sb.append(new StringBuilder(2 + string2.length()).append(", ").append(string2).toString());
        }
        if (iterator.hasNext()) {
            sb.append(", ...");
        }
    ...
    public static <T> T get(Iterator<T> iterator, int position) {
        ...
        if (!iterator.hasNext()) {
            int n = position;
            int n2 = skipped;
            throw new IndexOutOfBoundsException(new StringBuilder(91).append("position (").append(n).append(") must be less than the number of elements that remained (").append(n2).append(")").toString());
        }
