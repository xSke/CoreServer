...
extends AbstractRangeSet<C> {
    ...
    public Set<Range<C>> asRanges() {
        ...
        AsRanges asRanges = result == null ? (this.asRanges = new AsRanges()) : result;
        return asRanges;
    }
        ...
        Iterator<Map.Entry<Cut<C>, Range<C>>> descendingEntryIterator() {
            ...
            return new AbstractIterator<Map.Entry<Cut<C>, Range<C>>>(){
                ...
                protected Map.Entry<Cut<C>, Range<C>> computeNext() {
                    ...
                    Range nextRange = (Range)completeRangeItr.next();
                    if (SubRangeSetRangesByLowerBound.access$300((SubRangeSetRangesByLowerBound)SubRangeSetRangesByLowerBound.this).lowerBound.compareTo(nextRange.upperBound) >= 0) {
                        return (Map.Entry)this.endOfData();
                    }
                    nextRange = nextRange.intersection(SubRangeSetRangesByLowerBound.this.restriction);
        ...
        Iterator<Map.Entry<Cut<C>, Range<C>>> entryIterator() {
            ...
            return new AbstractIterator<Map.Entry<Cut<C>, Range<C>>>(){
                ...
                protected Map.Entry<Cut<C>, Range<C>> computeNext() {
                    ...
                    if (ComplementRangesByLowerBound.access$100((ComplementRangesByLowerBound)ComplementRangesByLowerBound.this).upperBound.isLessThan(this.nextComplementRangeLowerBound) || this.nextComplementRangeLowerBound == Cut.aboveAll()) {
                        return (Map.Entry)this.endOfData();
                    }
            ...
            return new AbstractIterator<Map.Entry<Cut<C>, Range<C>>>(){
                ...
                protected Map.Entry<Cut<C>, Range<C>> computeNext() {
                    ...
                    if (positiveItr.hasNext()) {
                        ...
                        if (ComplementRangesByLowerBound.access$100((ComplementRangesByLowerBound)ComplementRangesByLowerBound.this).lowerBound.isLessThan(negativeRange.lowerBound)) {
                            return Maps.immutableEntry(negativeRange.lowerBound, negativeRange);
                        }
                    } else if (ComplementRangesByLowerBound.access$100((ComplementRangesByLowerBound)ComplementRangesByLowerBound.this).lowerBound.isLessThan(Cut.belowAll())) {
        ...
        Iterator<Map.Entry<Cut<C>, Range<C>>> entryIterator() {
            ...
            return new AbstractIterator<Map.Entry<Cut<C>, Range<C>>>(){
                ...
                protected Map.Entry<Cut<C>, Range<C>> computeNext() {
                    ...
                    if (RangesByUpperBound.access$000((RangesByUpperBound)RangesByUpperBound.this).upperBound.isLessThan(range.upperBound)) {
                        return (Map.Entry)this.endOfData();
                    }
        ...
        Iterator<Map.Entry<Cut<C>, Range<C>>> descendingEntryIterator() {
            ...
            return new AbstractIterator<Map.Entry<Cut<C>, Range<C>>>(){
                ...
                protected Map.Entry<Cut<C>, Range<C>> computeNext() {
                    ...
                    Range range = (Range)backingItr.next();
                    return RangesByUpperBound.access$000((RangesByUpperBound)RangesByUpperBound.this).lowerBound.isLessThan(range.upperBound) ? Maps.immutableEntry(range.upperBound, range) : (Map.Entry<Cut<C>, Range<C>>)this.endOfData();
                }
            };
        }
