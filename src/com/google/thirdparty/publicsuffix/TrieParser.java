...
class TrieParser {
    ...
    static ImmutableMap<String, PublicSuffixType> parseTrie(CharSequence encoded) {
        ...
        for (int idx = 0; idx < encodedLen; idx += TrieParser.doParseTrieToBuilder(Lists.<CharSequence>newLinkedList(), (CharSequence)encoded.subSequence((int)idx, (int)encodedLen), builder)) {
        }
